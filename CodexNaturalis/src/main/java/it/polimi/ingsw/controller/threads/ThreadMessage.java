...
public record ThreadMessage(Status status, String player, String type, String[] args, UUID messageUUID) {
    ...
    public static ThreadMessage create(String username, Integer playerNum, UUID gameId) {
        return new ThreadMessage(Status.REQUEST, username, "create", new String[]{playerNum.toString(), gameId.toString()}, UUID.randomUUID());
    }
    ...
    public static ThreadMessage join(String username) {
        return new ThreadMessage(Status.REQUEST, username, "join", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage placeCard(String username, Coordinates coordinates, Integer cardId) {
        return new ThreadMessage(Status.REQUEST, username, "place", new String[]{coordinates.x().toString(), coordinates.y().toString(), cardId.toString()}, UUID.randomUUID());
    }
    ...
    public static ThreadMessage update(String username) {
        return new ThreadMessage(Status.REQUEST, username, "update", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage draw(String username, Integer position) {
        return new ThreadMessage(Status.REQUEST, username, "draw", new String[]{position.toString()}, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getScoreMap(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getScoreMap", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getHand(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getHand", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getCommonObjectives(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getCommonObjectives", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getPersonalObjective(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getPersonalObjective", null, UUID.randomUUID());
    }
    ...
    /**
     * Creates a ThreadMessage for requesting the available colors.
     *
     * @param username the username of the player making the request
     * @return a ThreadMessage object encapsulating the request to get available colors
     */
    ...
    public static ThreadMessage getPlayerResources(String username, String usernameRequiredData) {
        return new ThreadMessage(Status.REQUEST, username, "getPlayerResources", new String[]{usernameRequiredData}, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getVisibleCards(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getVisibleCards", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getBackSideDecks(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getBackSideDecks", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getValidPlacements(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getValidPlacements", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getBoard(String username, String usernameRequiredData) {
        return new ThreadMessage(Status.REQUEST, username, "getBoard", new String[]{usernameRequiredData}, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getPlacingOrder(String username, String usernameRequiredData) {
        return new ThreadMessage(Status.REQUEST, username, "getPlacingOrder", new String[]{usernameRequiredData}, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getPlayers(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getPlayers", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage getGameState(String username) {
        return new ThreadMessage(Status.REQUEST, username, "getGameState", null, UUID.randomUUID());
    }
    ...
    public static ThreadMessage genericError(String username, UUID messageUUID, String cause) {
        return new ThreadMessage(Status.ERROR, username, "genericError", new String[]{cause}, messageUUID);
    }
    ...
    public static ThreadMessage okResponse(String username, UUID messageUUID) {
        return new ThreadMessage(Status.OK, username, "ok", null, messageUUID);
    }
    ...
    public static ThreadMessage updateResponse(String username, boolean playerTurn, UUID messageUUID) {
        return new ThreadMessage(Status.OK, username, "updateResponse", new String[]{String.valueOf(playerTurn)}, messageUUID);
    }
    ...
    public static ThreadMessage drawResponse(String username, Integer cardId, UUID messageUUID) {
        return new ThreadMessage(Status.OK, username, "drawResponse", new String[]{cardId.toString()}, messageUUID);
    }
    ...
    public static ThreadMessage getStartingCardResponse(String username, Integer cardId, UUID messageUUID) {
        return new ThreadMessage(Status.OK, username, "getStartingCardResponse", new String[]{cardId.toString()}, messageUUID);
    }
    ...
    public static ThreadMessage getScoreMapResponse(String username, ConcurrentHashMap<String, Integer> scoreMap, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getScoreMapResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getHandResponse(String username, ArrayList<Integer> handIds, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getHandResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getCommonObjectivesResponse(String username, ArrayList<Integer> startingObjectivesIds, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getCommonObjectivesResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getPersonalObjectiveResponse(String username, Integer objectiveId, UUID messageUUID) {
        return new ThreadMessage(Status.OK, username, "getPersonalObjectiveResponse", new String[]{objectiveId.toString(),}, messageUUID);
    }
    ...
    /**
     * Creates a ThreadMessage for available colors response.
     *
     * @param username        The username of the player.
    ...
    public static ThreadMessage getPlayerResourcesResponse(String username, ConcurrentHashMap<Resource, Integer> playerResources, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getPlayerResourcesResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getBackSideDecksResponse(String username, ArrayList<Integer> backSideCardsIds, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getBackSideDecksResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getValidPlacementsResponse(String username, Set<Coordinates> validPlacements, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getValidPlacementsResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getBoardResponse(String username, HashMap<Coordinates, Integer> board, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getBoardResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getPlacingOrderResponse(String username, Deque<Integer> order, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getPlacingOrderResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getPlayersResponse(String username, ArrayList<String> players, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getPlayersResponse", args, messageUUID);
    }
    ...
    public static ThreadMessage getAvailableGamesResponse(String username, ArrayList<UUID> availableGames, UUID messageUUID) {
        ...
        return new ThreadMessage(Status.OK, username, "getAvailableGamesResponse", args, messageUUID);
    }
