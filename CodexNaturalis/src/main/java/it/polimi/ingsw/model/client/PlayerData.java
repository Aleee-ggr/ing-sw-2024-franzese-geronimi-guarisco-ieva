...
public class PlayerData extends ClientData {
     ...
     *
     * @return the ArrayList of available colors for the player to choose from
     */
    ...
    /**
     * Setter for the available colors.
     *
     * @param availableColors the ArrayList of available colors for the player to choose from
     */
