...
public class ChooseObjectiveController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        String imagePath = String.format("GUI/images/cards/front/%03d.png", firstObjectiveId);
        ...
        String imagePathSecond = String.format("GUI/images/cards/front/%03d.png", secondObjectiveId);
